  ...
  return (
    <div className="bg-white px-4 md:px-10 py-12 max-w-7xl mx-auto font-family">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-12">
        ...
        <div className="space-y-6 flex flex-col" data-aos="fade-right">
        ...
        >
          ...
          <form className="space-y-4">
            <input
              ...
              className="w-full p-3 border border-gray-300 focus:border-green-600 focus:outline-none rounded"
              required
            />
            <input
              type="email"
      ...
      {/* Google Map Section */}
      <div
        className="h-[300px] md:h-[400px] w-full rounded overflow-hidden shadow-md"
        data-aos="zoom-in"
      >
        <iframe
          title="Google Map"
