...
const About = () => {
  return (
    <div className="font-family flex flex-col lg:flex-row items-center justify-between 
    gap-10 p-6 lg:p-16 bg-white overflow-hidden">
      {/* Left Side - Images */}
      <div className="relative w-full max-w-[320px] h-[350px] mx-auto">
        {/* Back Image */}
        <img
          src={classroomImage}
          alt="Classroom"
        ...
        {/* Green line (optional decorative bar) */}
        <div className="absolute md:top-[220px] md:left-[40px] top-55 left-10 w-25  md:w-50 h-[4px] bg-primary z-20"></div>

        {/* Badge */}
        <div className="absolute top-4 md:left-54 left-54 bg-secondary text-white text-lg sm:text-base 
      ...
      <div className="w-full lg:w-1/2 text-center lg:text-left mt-6 lg:mt-0">
        <p className="text-lg text-gray-500 mb-2">About us</p>
        <h2 className="text-2xl lg:text-3xl font-bold mb-4">Who We Are</h2>
        <p className="text-gray-600 mb-4 text-md md:text-lg leading-relaxed">
        ...
        <p className="text-gray-600 mb-6 leading-relaxed text-md md:text-lg">
